...
public class Application {
    public static void main(String[] args) {
         ...
         * 2. 사용자 정의의 자료형인 클래스를 생성하면, 클래스에 우리가 정의한 필드(전역변수),
         * 메서드 대로 객체가 생성된다.
         * */
        ...
        * 주소에 접근하겠다는 의미이다.*/
        ...
        System.out.println("member가 가진 이름" + member.id);
        System.out.println("member가 가진 나이" + member.pwd);
    }
}
